  ...
  return (
    <motion.div
      ...
      <div
        ...
        ref={measureRef}>
        {title && <div className="mb-2 text-xs font-medium text-zinc-400">{title}</div>}
          ...
          {rows.map((row) => (
            <div
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm text-zinc-100 dark:text-zinc-400">{row.label}</span>
              </div>
              <span className="text-sm font-medium text-white tabular-nums dark:text-zinc-800">
