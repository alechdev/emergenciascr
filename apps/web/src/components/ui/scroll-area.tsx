...
function ScrollArea({
  ...
  scrollFade?: boolean | "top" | "bottom" | "both" | "all";
  scrollbarGutter?: boolean;
}) {
  const showAllFade = scrollFade === true || scrollFade === "all";
  const showTopFade = showAllFade || scrollFade === "top" || scrollFade === "both";
  const showBottomFade = showAllFade || scrollFade === "bottom" || scrollFade === "both";
    ...
    <ScrollAreaPrimitive.Root
      ...
      <ScrollAreaPrimitive.Viewport
        className={cn(
          ...
          showAllFade &&
            "mask-r-from-[calc(100%-min(var(--fade-size),var(--scroll-area-overflow-x-end)))] mask-l-from-[calc(100%-min(var(--fade-size),var(--scroll-area-overflow-x-start)))]",
          (showTopFade || showBottomFade || showAllFade) && "[--fade-size:1.5rem]",
